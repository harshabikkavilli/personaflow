...
export function LandingPage() {
	return (
		<div className='flex-1 flex flex-col'>
			...
			{/* Features Section */}
			<section className='py-20 bg-[var(--pf-bg-secondary)] border-y border-[var(--pf-border)]'>
				<div className='max-w-7xl mx-auto px-6'>
					...
					<div className='grid md:grid-cols-3 gap-6'>
						<div className='bg-[var(--pf-bg-tertiary)] border border-[var(--pf-border)] rounded-xl p-6 space-y-4 hover:border-[var(--pf-border)]/80 transition-colors'>
							<div className='w-12 h-12 rounded-xl bg-[var(--pf-planner)]/10 flex items-center justify-center text-[var(--pf-planner)]'>
								<Workflow className='w-6 h-6' />
							</div>
							<h3 className='text-xl font-bold'>Design-First Workflow</h3>
							<p className='text-[var(--pf-text-secondary)]'>
								Map out complex state machines and multi-step reasoning before
								writing a single line of agent code.
							</p>
						</div>
						<div className='bg-[var(--pf-bg-tertiary)] border border-[var(--pf-border)] rounded-xl p-6 space-y-4 hover:border-[var(--pf-border)]/80 transition-colors'>
							<div className='w-12 h-12 rounded-xl bg-[var(--pf-critic)]/10 flex items-center justify-center text-[var(--pf-critic)]'>
								<Network className='w-6 h-6' />
							</div>
							<h3 className='text-xl font-bold'>Framework Agnostic</h3>
							<p className='text-[var(--pf-text-secondary)]'>
								Export to LangGraph, CrewAI, or vanilla Python. We focus on the
								logic, you choose the runtime.
							</p>
						</div>
						<div className='bg-[var(--pf-bg-tertiary)] border border-[var(--pf-border)] rounded-xl p-6 space-y-4 hover:border-[var(--pf-border)]/80 transition-colors'>
							<div className='w-12 h-12 rounded-xl bg-[var(--pf-human)]/10 flex items-center justify-center text-[var(--pf-human)]'>
								<Shield className='w-6 h-6' />
							</div>
							<h3 className='text-xl font-bold'>Risk-Aware Verifiers</h3>
							<p className='text-[var(--pf-text-secondary)]'>
								Built-in nodes for human-in-the-loop and automated verification
						...
						{featuredTemplates.map((template) => {
							...
							return (
								<Link
									key={template.id}
									to='/examples'
									className='group bg-[var(--pf-bg-secondary)] rounded-2xl border border-[var(--pf-border)] overflow-hidden hover:border-[var(--pf-primary-gradient)]/50 transition-all'>
			...
			{/* Footer */}
			<footer className='py-20 bg-[var(--pf-bg-primary)] border-t border-[var(--pf-border)]'>
				<div className='max-w-7xl mx-auto px-6'>
					<div className='flex flex-col md:flex-row items-center justify-between gap-12 bg-[var(--pf-bg-secondary)]/50 p-8 md:p-12 rounded-3xl border border-[var(--pf-border)]'>
						<div>
					...
					<div className='mt-20 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-[var(--pf-text-muted)]'>
